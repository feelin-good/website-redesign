          ...
          {SERVICES.map((service, i) => (
            <AnimateOnScroll key={service.id} animation="fade-up" delay={i * 80}>
              <Link
                ...
                className="group flex flex-col h-full bg-canvas rounded-card shadow-lab
                           hover:-translate-y-1 transition-all duration-300 overflow-hidden"
              >
                {/* Accent bar */}
                <div className="h-1 bg-electric transform origin-left scale-x-0 group-hover:scale-x-100
                ...
                <div className="p-8 flex flex-col flex-1">
                  ...
                  <div className="w-12 h-12 rounded-control bg-ghost group-hover:bg-ink
                    ...
                    <span className="text-electric group-hover:text-canvas transition-colors duration-300">
                  ...
                  {/* Read more */}
                  <div className="flex items-center gap-1.5 text-sm font-semibold text-obsidian
                                  group-hover:text-electric group-hover:gap-3 transition-all duration-200">
