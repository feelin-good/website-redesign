    ...
    <div className="min-h-screen bg-canvas flex items-center justify-center px-4">
      <div className="text-center max-w-lg">
        ...
        <div className="flex gap-3 justify-center">
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-2 border border-granite/20 text-granite
                       font-medium px-6 py-3 rounded-full hover:bg-ghost-white transition-colors"
          >
            <Home size={16} /> Home
          </Link>
        </div>
