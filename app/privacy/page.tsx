    ...
    <div className="pt-32 pb-20 bg-ghost-white min-h-screen">
      <div className="container-main max-w-4xl">
        ...
        <div className="bg-white rounded-2xl border border-alabaster shadow-card p-8 lg:p-12 prose-lepton space-y-8">
          ...
          <section>
            <h2 className="font-display font-bold text-xl text-navy-900 mb-3">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="font-display font-bold text-xl text-navy-900 mb-3">3. Information Sharing</h2>
          ...
          <section>
            <h2 className="font-display font-bold text-xl text-navy-900 mb-3">4. Data Security</h2>
          ...
          <section>
            <h2 className="font-display font-bold text-xl text-navy-900 mb-3">5. Contact Us</h2>
            <p>For privacy-related queries, contact us at <a href="mailto:privacy@lepton.co.in" className="text-orange-500 hover:underline">privacy@lepton.co.in</a>.</p>
          </section>
        </div>
      </div>
    </div>
